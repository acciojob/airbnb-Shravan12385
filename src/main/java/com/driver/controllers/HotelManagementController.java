...
import com.driver.Service.HotelManagementSerivce;
...
public class HotelManagementController {
    @Autowired
    HotelManagementSerivce hotelManagementSerivce;
    ...
    public String getHotelWithMostFacilities(){
        ...
        if(hotelManagementSerivce.getHotelWithMostFacilities()!=null) return  hotelManagementSerivce.getHotelWithMostFacilities().getHotelName();
        else return "";
    }
    ...
    public int getBookings(@PathVariable("aadharCard")Integer aadharCard)
    {
        ...
        return hotelManagementSerivce.getBooking(aadharCard);
